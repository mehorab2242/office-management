...
const formOpen = ref(false); const editingExpenseId = ref<number | null>(null);
...
function startCreate(): void {
    editingExpenseId.value = null; formOpen.value = true;
}

function startEdit(expense: Expense): void { editingExpenseId.value = expense.id; formOpen.value = true; }
...
<template>
    <AppLayout>
        ...
        <ExpenseFormDialog v-model:open="formOpen" :expense-id="editingExpenseId" @saved="load(meta.current_page)" />
